...
exports.Axios = Axios;
Axios.trimError = (reason) => {
    var _a, _b, _c;
    return {
        type: 'Severe Axios error',
        url: (_a = reason.config) === null || _a === void 0 ? void 0 : _a.url,
        verb: reason.request.method,
        response: {
            status: (_b = reason.response) === null || _b === void 0 ? void 0 : _b.status,
            statusText: (_c = reason.response) === null || _c === void 0 ? void 0 : _c.statusText
        }
    };
};
